...
void require_tensor_close(
    ...
    const coooda_core::test::MismatchReport report =
        coooda_core::test::compare_vectors(label, expected_values, tensor_values(actual), 1.0e-5f, 1.0e-5f);
...
int main() {
    return coooda_core::test::run_tests({
        ...
        {"matmul_cuda_rectangular_output", []() {
             const coooda_core::Tensor a = tensor_from_values(
                 {{3, 2}},
                 {1.0f, 2.0f,
                  -1.0f, 0.5f,
        ...
        {"matmul_cuda_allows_empty_2d_output", []() {
        ...
        {"matmul_cuda_rejects_non_matrix_inputs", []() {
             require_core_error(
                 []() {
        ...
        {"matmul_cuda_rejects_inner_dimension_mismatch", []() {
             require_core_error(
                 []() {
                     const coooda_core::Tensor a({{2, 3}});
